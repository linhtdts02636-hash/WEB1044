...
function isEven(num) {
  if (num % 2 === 0) {
    ...
    return("ts NOT even twin ✌️😭 ");
  }
}

console.log(isEven(numberIn));
...
function calcMoney(input) {
  ...
  return(Math.round(input * rate));
}

let gay = 50;
console.log(calcMoney(gay));
...
console.log(calcElectricity(300000));
...
return(Math.round(rankRate * dayInput * baseSalary/requiredWorkDay))
}

console.log(calcSalary(30,rank.INTERN))